...
- `/baa game [arena_id] all_against_all setmode <last_standing|most_kills>` — Choose the win condition.
- `/baa game [arena_id] all_against_all setregion set` — Select and save the combat region using the setup tool.

## Technical details
- **Minigame ID:** `all_against_all`
